class DremioBatchExecute < Formula
  ...
  homepage "https://github.com/rsvihladremio/dremio-batch-execute"
  version "0.1.0"

  # Define the download URLs and corresponding SHA256 checksums for the binary releases
  url "https://github.com/rsvihladremio/dremio-batch-execute/releases/download/v#{version}/dremio-batch-execute-darwin-amd64.zip"
  sha256 "8b70bf8ddfee3ca430c6a756ee46f9f073af2a190cf6e0d70201f50c44db71c3"

  if Hardware::CPU.arm?
    url "https://github.com/rsvihladremio/dremio-batch-execute/releases/download/v#{version}/dremio-batch-execute-darwin-arm64.zip"
